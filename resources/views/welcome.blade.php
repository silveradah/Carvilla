        ...
        <section id="home" class="welcome-hero">
            ...
            <div class="top-area">
                <div class="header-area">
                    <!-- Start Navigation -->
                    <div class="wrap-sticky" style="height: 66px;">
                        <nav class="navbar navbar-default bootsnav  navbar-sticky navbar-scrollspy on no-full"
            ...
            <div class="container">
                <div class="welcome-hero-txt">
                    <h2 class="animated fadeInUp" style="opacity: 0;">get your desired car in resonable price</h2>
                    <p class="animated fadeInUp" style="opacity: 0;">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna aliqua.
                    </p>
                    <button class="welcome-btn animated fadeInDown" onclick="window.location.href='#'"
                        style="opacity: 0;">contact us</button>
                </div>
            </div>
        ...
        <section id="new-cars" class="new-cars">
            <div class="container">
                ...
                <div class="new-cars-content">
                    <div class="owl-carousel owl-theme owl-loaded owl-drag" id="new-cars-carousel">
                        <!--/.new-cars-item-->
                        <!--/.new-cars-item-->
                        <!--/.new-cars-item-->
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                style="transform: translate3d(-1440px, 0px, 0px); transition: all; width: 5040px;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-sm-12">
                                                    <div class="new-cars-img">
                                                        <img src="assets/images/new-cars-model/ncm2.png"
                                                            alt="img">
                                                    </div><!--/.new-cars-img-->
                                                </div>
                                    ...
                                    <div class="new-cars-item">
                                        <div class="single-new-cars-item">
                                            <div class="row">
                                                <div class="col-md-7 col-sm-12">
                                                    <div class="new-cars-img">
                                                        <img src="assets/images/new-cars-model/ncm3.png"
                                                            alt="img">
                                                    </div><!--/.new-cars-img-->
                                                </div>
                                                <div class="col-md-5 col-sm-12">
                                    ...
                                    <div class="new-cars-item">
                                        <div class="single-new-cars-item">
                                            <div class="row">
                                                <div class="col-md-7 col-sm-12">
                                                    <div class="new-cars-img">
                                                        <img src="assets/images/new-cars-model/ncm1.png"
                                                            alt="img">
                                                    </div><!--/.new-cars-img-->
                                                </div>
                                                <div class="col-md-5 col-sm-12">
                                                    <div class="new-cars-txt">
                                                        <h2><a href="#">chevrolet camaro <span> za100</span></a>
                                                        </h2>
                                                        <p>
                                                            Duis aute irure dolor in reprehenderit in voluptate velit
                                                            esse cillum dolore eu fugiat nulla pariatur. Excepteur sint
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="owl-carousel testimonial-carousel owl-loaded owl-drag">
                        ...
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                style="transform: translate3d(-750px, 0px, 0px); transition: 1s; width: 2625px;">
                                        ...
                                        <div class="single-testimonial-box">
                                            <div class="testimonial-description">
                                                ...
                                                <div class="testimonial-comment">
                                                    <p>
                                                        Sed ut pers unde omnis iste natus error sit voluptatem
                                                        accusantium dolor laudan rem aperiam, eaque ipsa quae ab illo
                                                        inventore verit.
                                                    </p>
            ...
            <div class="container">
                <div class="brand-area">
                    <div class="owl-carousel owl-theme brand-item owl-loaded owl-drag">
                        ...
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                style="transform: translate3d(-720px, 0px, 0px); transition: 1s; width: 2880px;">
